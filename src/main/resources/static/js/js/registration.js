function TypeControl() {
    ...
    if (type.value == "Student") {
        ...
        dojInput.innerHTML = '<div class="input-group"><div class="input-group-addon" style="padding-left: 10px; padding-right: 10px; padding-top: 16px;">Join Date</div><input type="date" class="form-control" name="doj" id="doj" required="true" onchange="SID();"></div>';
        SID();
...
function SID() {
    ...
    if (type.value == "Student") {
        ...
        sidInput.innerHTML = '<div class="input-group"><div class="input-group-addon" style="padding-left: 10px; padding-right: 10px; padding-top: 16px;">'+idPrefix+'</div><input type="text" class="form-control" name="sid" id="sid" placeholder="Enter your Student ID" required="true"/></div>';
