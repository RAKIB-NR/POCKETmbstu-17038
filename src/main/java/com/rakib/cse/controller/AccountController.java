...
import com.rakib.cse.pojo.*;
import com.rakib.cse.services.AccountService;
import com.rakib.cse.view.AccountView;
...
public class AccountController {
    ...
    private static String userTypeS = null;
    ...
    @RequestMapping(value = "/{userType}/account/{username}/imageUpload")
    public String Upload(Model model, HttpServletRequest request, @PathVariable String userType, @PathVariable String username) throws IOException {
        ...
        String b64Img = DatatypeConverter.printBase64Binary(img);

        accountService.updateImage(userType, username, img);
        byte[] resultImage = accountService.getImage(userType, username);
        if (img != null) image = Base64.getEncoder().encodeToString(resultImage);
_*/
    ...
    public String Account(Model model, HttpSession session, HttpServletRequest request, HttpServletResponse response, @PathVariable String userType, @PathVariable String username) throws IOException, URISyntaxException {
        SessionController.KeepSession(session);
        if (request.getMethod().equalsIgnoreCase("POST")) {
            String updateType = request.getParameter("updateType");
            String value = request.getParameter("updateValue");
            accountService.updateData(userType, username, updateType, value);
        }
    ...
    public String Profile(Model model, HttpSession session, HttpServletRequest request, @PathVariable String username, @PathVariable String userType) {
        SessionController.KeepSession(session);
 ...
 */
    ...
    public String ProfileContact(Model model, HttpSession session, HttpServletRequest request, @PathVariable String userType, @PathVariable String username) {
        SessionController.KeepSession(session);
