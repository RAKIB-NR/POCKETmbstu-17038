...
@Entity
@Table(name = "STUDENTSEMESTER", schema = "SABBIR")


/*
 * call pkg_std_perf.studentSemesterMarks stored procedure
 */

@NamedStoredProcedureQuery(
        name="studentSemesterMarks",
        procedureName="pkg_std_perf.studentSemesterMarks",
        parameters={
...
public class StudentSemesterEntity {
    ...
    public boolean equals(Object o) {
        ...
        StudentSemesterEntity that = (StudentSemesterEntity) o;
