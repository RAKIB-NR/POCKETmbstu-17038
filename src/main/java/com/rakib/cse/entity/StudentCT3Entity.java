...
@Entity
@Table(name = "STUDENTCT3", schema = "SABBIR")
...
@NamedStoredProcedureQuery(
        name="studentCT3Marks",
        procedureName="pkg_std_perf.studentCT3Marks",
        parameters={
...
public class StudentCT3Entity {
    ...
    public boolean equals(Object o) {
        ...
        StudentCT3Entity that = (StudentCT3Entity) o;
