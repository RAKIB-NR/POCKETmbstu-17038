...
import com.rakib.cse.pojo.ProfileIntro;
...
/*
 * call pkg_std_perf.updateImage stored procedure
 */

@NamedStoredProcedureQuery(
        name="updateImage",
        procedureName="pkg_std_perf.updateImage",
        parameters={
                @StoredProcedureParameter(name="inUserType", type=String.class, mode=ParameterMode.IN),
                @StoredProcedureParameter(name="inUsername", type=String.class, mode=ParameterMode.IN),
                @StoredProcedureParameter(name="inImage", type=byte[].class, mode=ParameterMode.IN)
        }
)
...
/*
 * call pkg_std_perf.updateData stored procedure
 */

@NamedStoredProcedureQuery(
        name="updateData",
        procedureName="pkg_std_perf.updateData",
        parameters={
                @StoredProcedureParameter(name="inUserType", type=String.class, mode=ParameterMode.IN),
                @StoredProcedureParameter(name="inUsername", type=String.class, mode=ParameterMode.IN),
                @StoredProcedureParameter(name="inUpdateType", type=String.class, mode=ParameterMode.IN),
                @StoredProcedureParameter(name="inValue", type=String.class, mode=ParameterMode.IN)
        }
)
