package com.rakib.cse.services;
...
public class AccountService {
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public void updateImage (String userType, String username, byte[] image) {
        StoredProcedureQuery storedProcedureQuery = entityManager.createNamedStoredProcedureQuery("updateImage");
        storedProcedureQuery.setParameter("inUserType", userType);
        storedProcedureQuery.setParameter("inUsername", username);
    ...
    @SuppressWarnings("unchecked")
    public void updateData (String userType, String username, String updateType, String value) {
        StoredProcedureQuery storedProcedureQuery = entityManager.createNamedStoredProcedureQuery("updateData");
        storedProcedureQuery.setParameter("inUserType", userType);
        storedProcedureQuery.setParameter("inUsername", username);
        storedProcedureQuery.setParameter("inUpdateType", updateType);
        storedProcedureQuery.setParameter("inValue", value);
        storedProcedureQuery.execute();
    }
}
